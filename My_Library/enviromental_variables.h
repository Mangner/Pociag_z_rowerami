...
#define MaxGeneratedPassengersAmount 200	// Maksymalna liczba pasażerów do wygenerowania
...
#define T1 20 			// Czas w sekundach po którym pociągi wracają na dworzec
